...
#
# Ez a dev branch venv-szkriptje: mindig a requirements-dev.txt-et telepíti
# (ami a requirements.txt-et is magában foglalja -r requirements.txt sorral),
# tehát a Ruff és Pyright is mindig települ - de a szkript maga nem futtat
# ruff check-et, azt kézzel indítod, amikor szükséges (lásd a szkript végén
# kiírt emlékeztetőt).
#
# Használat:
#   ./build-venv.sh
